// Esta constante que buscará as informações na URL para erro, sucesso e outros processos
...
// Neste caso, se ao realizar o login, o usuário digitar a senha incorreta, a URL receberá a chave e valor como erro=login, indicando falha nesta etapa.
// Desta forma, aparecerá uma mensagem informando o erro, acima do formulário de login.
if (erro === "login") {
    document.getElementById("mensagem").innerHTML = `
